...
namespace TakipSiparis.Models
{
    public class DataLayer
    {
        ...
        {
            List<Attachments> DetList = new List<Attachments>();
            DetList = SqlMapper.Query<Attachments>(Con, "GetFileDetails", commandType: CommandType.StoredProcedure).ToList();
            return DetList;
        }

        public bool SaveFileDetails(Attachments objDet)
        {
            try
            {
